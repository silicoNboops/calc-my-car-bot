...
> Примечание: чтобы избежать дублирования, раздел про ENV и dev-зависимости вынесен в основной README. См. «[Dev-зависимости (локальная разработка)](../README.md#dev-зависимости-локальная-разработка)».
