...
PROMPT_ENTER_ENGINE_HP = (
    "Введите <b>мощность</b> двигателя (например, 150):\n\n"
    "<i>Также выберите единицу мощности кнопками ниже.</i>"
)
PROMPT_ENTER_ENGINE_HP_SIMPLE = (
    "Введите <b>мощность</b> двигателя в л.с (например, 150):"
)
PROMPT_ENTER_ENGINE_HP_30MIN_KW = (
    "Введите максимальную 30-минутную <b>мощность</b> электродвигателя в кВт (например, 120):\n\n"
    "<i>Также выберите единицу мощности кнопками ниже.</i>"
)

PROMPT_ENTER_ENGINE_HP_30MIN_HP = (
    "Введите максимальную 30-минутную <b>мощность</b> электродвигателя в л.с (например, 120):\n\n"
    "<i>Также выберите единицу мощности кнопками ниже.</i>"
)

def get_power_prompt_for_unit(unit: str) -> str:
    """Возвращает промпт для ввода мощности в зависимости от единицы измерения."""
    if unit == "kw":
        return PROMPT_ENTER_ENGINE_HP_30MIN_KW
    else:
        return PROMPT_ENTER_ENGINE_HP_30MIN_HP
...
CONTACT_LINE = (
    "\nОбъявления тут: <b>@ChinaMotors123</b>"
